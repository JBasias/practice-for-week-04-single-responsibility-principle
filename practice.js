...
function BakeThePies(pieType, pieQuantity)
{
...
function TotalRevenue(costOfPie, profitMargin, pieQuantity)
{
...
function CostOfThePies(recipe, pieQuantity, profitMargin)
{
  ...
  */
  ...
  TotalRevenue(costOfPie, profitMargin, pieQuantity);
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  const recipe = recipes[pieType];
  BakeThePies(pieType, pieQuantity);

  // Print the cost of each pie based on the cost of each ingredient

  CostOfThePies(recipe, pieQuantity, profitMargin);
